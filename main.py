...
tf.app.flags.DEFINE_float('sketch_learning_rate',0.0001,'generator learning rate') # 0.0001 # 1e-5 # 0.0001 # 1e-4 # 0.0001 # 0.0001
...
def main(_):
	...
	with tf.Session() as sess:
		...
		model = Coop_pix2pix(sess, 
				...
				sketch_learning_rate = FLAGS.sketch_learning_rate,
